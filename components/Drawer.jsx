...
const Drawer = () => {
  ...
  const x=useTransform(scrollYProgress,[0,0.478,1],[-200,0.1,0.1]);
  const x3=useTransform(scrollYProgress,[0,0.478,1],[200,0.1,0.1]);

  const x2=useTransform(scrollYProgress,[0,0.478,1],[-40,0.1,0.1]);
